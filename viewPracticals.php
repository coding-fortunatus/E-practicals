...
if(!$_SESSION["loggedin"] === true){
    ...
    // Get all course related to lecturer
    $lecturerCourses = getLecturerCourses($lecturer_id);
    // Check for the course clicked on and redirect to the course page for further actions
    if (isset($_GET['course_id'])) {
        // Store the course id into a session variable
        $_SESSION['course_id'] = $_GET['course_id'];
        header("Location: ./classCourse.php");
    }
}
